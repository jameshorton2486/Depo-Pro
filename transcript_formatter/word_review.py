...
FIXES vs. original:
  ...
  FIX-3  Tab stop positions: uses Inches() values aligned with the 5-stop UFM layout
         (0.25", 0.625", 1.0", 1.5", 2.0") instead of arbitrary manual math.
...
def apply_tab_stops(paragraph) -> None:
    ...
    try:
        ...
        tab_stops.Add(Position=_TAB4_PT)
        tab_stops.Add(Position=_TAB5_PT)
