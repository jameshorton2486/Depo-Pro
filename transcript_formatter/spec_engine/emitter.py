...
TYPOGRAPHY (must match exactly — Spec Section 5.2):
  ...
  Line spacing: Double
  Tab stops:    720 / 1440 / 2160 / 2880 twips
  Margins:      Left 1.25" / Right 0.75" / Top 1.0" / Bottom 1.0"
...
# ── Tab stop positions in twips (DP-011 canonical geometry) ───────────────────
TAB_720 = 720     # 0.5"  — Q./A. designation
TAB_1440 = 1440   # 1.0"  — Q./A. text start
TAB_2160 = 2160   # 1.5"  — Speaker label / new paragraph
TAB_2880 = 2880   # 2.0"  — Parenthetical
_STANDARD_TABS = [TAB_720, TAB_1440, TAB_2160, TAB_2880]
...
def emit_pn_line(doc: Document, text: str):
    ...
    for line in _wrap_lines(text, WRAP_WIDTH):
        para = doc.add_paragraph()
        _set_paragraph_format(para, [TAB_2880])
