...
- focused Export Adapter/UI protocol suite: 28 targeted tests passed for the latest staging and UI fixes;
...
- deployed versions: `export-adapter` v12 and `export-adapter-relay` v1;
...
Production end-to-end acceptance passed after the relay deployment on July 22, 2026. Fabricated case `RC17C-RELAY-CASE-6db9f1017796`, transcript `rc17c-relay-transcript-6db9f1017796`, and job `export-2e93889dfbab217fe58ba72b19ba9b71` traversed Application credentials -> Export Adapter -> staged GCS request object -> Cloud Tasks relay -> private Formatter Service -> Cloud Storage. The inline formatter body would have been 1,252,365 bytes; the relay task body was 205 bytes. Observed job lifecycle was `QUEUED -> PROCESSING -> COMPLETED`, with DOCX/PDF signed artifacts and duplicate idempotent create returning the same completed job. The staged request object `exports/requests/export-2e93889dfbab217fe58ba72b19ba9b71.json` was deleted after terminal formatter response; the completed job object remains at `exports/jobs/export-2e93889dfbab217fe58ba72b19ba9b71.json` generation `1784730797195214`.
