        ...
        methods: [
          {
            ...
            args: [{
              ...
              times_used: 0,
              provenance: {
                name: { rawInput: "Karen M. Alvarado", policyId: "intake.person_name", policyVersion: "1.0.0" },
                organization: { rawInput: "Brothers Law", policyId: "intake.organization", policyVersion: "1.0.0" },
                phone: { rawInput: "(210) 555-9999", policyId: "intake.phone_number", policyVersion: "1.0.0" },
              },
            }],
          },
          { name: "select", args: [] },
        ...
        methods: [
          {
            ...
            args: [{
              ...
              provenance: {
                organization: { rawInput: "Cukjati Law Firm", policyId: "intake.organization", policyVersion: "1.0.0" },
      ...
      methods: [
        {
          ...
          args: [{
            ...
            times_used: 0,
            provenance: {
              name: { rawInput: "Dana Helper", policyId: "intake.person_name", policyVersion: "1.0.0" },
              organization: { rawInput: "Brothers Law", policyId: "intake.organization", policyVersion: "1.0.0" },
              phone: { rawInput: "(210) 555-2222", policyId: "intake.phone_number", policyVersion: "1.0.0" },
            },
          }],
        },
        { name: "select", args: [] },
