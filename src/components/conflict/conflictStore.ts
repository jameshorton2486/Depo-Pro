...
interface ConflictContextValue {
  ...
  // Register an initial extraction event for a field
  recordExtraction: (
    caseId: string,
    fieldPath: string,
    fieldLabel: string,
  ...
  // Signal that two sources disagree on a field's value
  detectConflict: (
    caseId: string,
    fieldPath: string,
    fieldLabel: string,
  ...
  // Operator has chosen the winning value — resolves the conflict
  resolveConflict: (
    fieldPath: string,
  ...
  // Record that an operator confirmed a field without any conflict
  recordConfirm: (
    caseId: string,
    fieldPath: string,
    fieldLabel: string,
  ...
  // Open the resolution modal for a given field
  openModal: (fieldPath: string) => void;
  closeModal: () => void;

  // Load Supabase history into local state for a field
