        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 px-4">
          <div className="w-full max-w-2xl rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Transcript Reassembly</p>
                <h2 className="mt-2 text-xl font-semibold text-slate-900">Preview rebuilt transcript</h2>
              </div>
              <button
                type="button"
                onClick={() => {
            ...
            {loading && (
              <div className="mt-6 text-sm text-slate-600">Building rebuild preview…</div>
            )}
            ...
            {preview && (
              <div className="mt-6 space-y-6">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  >
                    {applying ? "Applying..." : "Apply Rebuild"}
                  </button>
                </div>
              </div>
            )}
