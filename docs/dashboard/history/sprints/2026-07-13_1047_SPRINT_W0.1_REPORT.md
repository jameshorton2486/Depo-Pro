...
- `npm test`: pending live execution after implementation
- `npm run typecheck`: pending live execution after implementation
- `npm run build`: pending live execution after implementation
- `npm run dashboard:update`: pending live execution after implementation
- `npm run sprint:complete`: pending live execution after implementation
