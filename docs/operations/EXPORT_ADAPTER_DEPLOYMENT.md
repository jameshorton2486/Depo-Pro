...
- Versions: `export-adapter` v12; `export-adapter-relay` v1
...
- Synthetic case: `RC17C-RELAY-CASE-6db9f1017796`
- Synthetic transcript: `rc17c-relay-transcript-6db9f1017796`
- Export job: `export-2e93889dfbab217fe58ba72b19ba9b71`
- Inline formatter envelope size: 1,252,365 bytes
- Relay Cloud Task envelope size: 205 bytes
- Staged request object: `exports/requests/export-2e93889dfbab217fe58ba72b19ba9b71.json`
- Staged request cleanup: object returned 404 after terminal formatter response
- Completed job object: `exports/jobs/export-2e93889dfbab217fe58ba72b19ba9b71.json`, generation `1784730797195214`, size 2,329 bytes
