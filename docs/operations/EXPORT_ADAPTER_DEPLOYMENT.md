...
- Versions: `export-adapter` v9; `export-adapter-relay` v1
...
- Synthetic case: `RC17C-RELAY-CASE-84fcaa8fd783`
- Synthetic transcript: `rc17c-relay-transcript-84fcaa8fd783`
- Export job: `export-02378a0cb4fc62dd577e67027a67feb6`
- Inline formatter envelope size: 1,252,365 bytes
- Relay Cloud Task envelope size: 205 bytes
- Staged request object: `exports/requests/export-02378a0cb4fc62dd577e67027a67feb6.json`
- Staged request cleanup: object returned 404 after terminal formatter response
- Completed job object: `exports/jobs/export-02378a0cb4fc62dd577e67027a67feb6.json`, generation `1784729045708531`, size 2,329 bytes
