...
- Sources read: **31** standards-bearing sources across the canonical standards folder, root standards docs, wave8 reference docs/code, and the frozen API contract (`Canonical Standards Folder`, `GEOMETRY_AUTHORITY_RECONCILIATION.md`, `CANONICAL_STANDARDS_INDEX.md`, `reference/wave8/docs`, `reference/wave8/backend`, `docs`, `src/api/types.ts`).
...
| `GEOMETRY_AUTHORITY_RECONCILIATION.md` | decision note | INCLUDED |
...
| --- | --- | --- | --- |
| Right margin | `0.75"` / 1080 (`Canonical Standards Folder/DP-011_CANONICAL_GEOMETRY_AUTHORITY.md`) | wave8 code already matches; older “1.0 inch others” note is superseded by DP-011 (`GEOMETRY_AUTHORITY_RECONCILIATION.md`) | RESOLVED |
...
| Q./A. designation tab | `720` / 0.5" (`Canonical Standards Folder/DP-011_CANONICAL_GEOMETRY_AUTHORITY.md`) | wave8 code still states `360`, identified as units bug (`reference/wave8/backend/geometry/profile.py:61`, `GEOMETRY_AUTHORITY_RECONCILIATION.md`) | RESOLVED AS AUTHORITY; CODE DIVERGES |
| Q/A text tab | `1440` / 1.0" (`Canonical Standards Folder/DP-011_CANONICAL_GEOMETRY_AUTHORITY.md`) | wave8 code still states `900`, identified as units bug (`reference/wave8/backend/geometry/profile.py:61`, `GEOMETRY_AUTHORITY_RECONCILIATION.md`) | RESOLVED AS AUTHORITY; CODE DIVERGES |
...
| Line spacing | `28pt exact` (`Canonical Standards Folder/DP-011_CANONICAL_GEOMETRY_AUTHORITY.md`) | wave8 code matches 28pt; competing 480/double language is superseded (`reference/wave8/backend/geometry/profile.py:53`, `GEOMETRY_AUTHORITY_RECONCILIATION.md`) | RESOLVED |
...
| Geometry supersession language | `GEOMETRY_AUTHORITY_RECONCILIATION.md`, `CANONICAL_STANDARDS_INDEX.md` | **AGREEING DUPLICATE**. Same disposition appears in two documents for indexing and rationale. | `Canonical Standards Folder/DP-011_CANONICAL_GEOMETRY_AUTHORITY.md` as authority; index/reconciliation as supporting records |
| Architecture-series boundary | `GEOMETRY_AUTHORITY_RECONCILIATION.md`, `CANONICAL_STANDARDS_INDEX.md`, `Canonical Standards Folder/WAVE21_CANONICAL_EXPORT_ARCHITECTURE.md` | **AGREEING DUPLICATE**. All three state that DP numbers are reserved for standards and WAVE-21 is architecture. | `CANONICAL_STANDARDS_INDEX.md` |
