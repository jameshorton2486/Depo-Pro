...
2. Then run the manual branch deletions from `GITHUB_CLEANUP_PLAN.md` (`feature/stage3-adapter-layer`, `feature/stage3-mount-contract`, `feature/stage3-provider-migration`). Retain `stage3-pre-merge-backup` until after a successful release merge.
